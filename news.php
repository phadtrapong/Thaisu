...
<body>
			...
			<form action="updateNews.php" method="post" enctype="multipart/form-data">
				<div class="form-outline form-add-item">
					<?php
                		...
                		$query = "SELECT * FROM output_images WHERE category = 'news1' ORDER BY imageId DESC LIMIT 1";
                		$query2 = "SELECT * FROM output_images WHERE category = 'news2' ORDER BY imageId DESC LIMIT 1";
                		$query3 = "SELECT * FROM output_images WHERE category = 'news3' ORDER BY imageId DESC LIMIT 1";
					...
					<div class="form-group">
						<label for="name">First Image</label>
					</div>
					<div class="form-group">
					...
					<hr>
					<div class="form-group">
						<label for="name">Second Image</label>
					</div>
					<div class="form-group">
						<span class="btn btn-default btn-file">
					...
					<hr>
					<div class="form-group">
						<label for="name">Third Image</label>	
					</div>
					<div class="form-group">
						<span class="btn btn-default btn-file">
	...
	<script src="js/uploadnews.js"></script>
