<?php
	...
	if(isset($_POST['btn-upload'])){
		...
		VALUES('{$imageProperties['mime']}', '{$imgData}', 'news1', 'news1')";
		$sqlnext = "SELECT * FROM output_images
		WHERE name = 'news1' and category = 'news1' ";

		$sql2 = "INSERT INTO output_images(imageType ,imageData, name, category)
		VALUES('{$imageProperties2['mime']}', '{$imgData2}', 'news2', 'news2')";
		$sqlnext2 = "SELECT * FROM output_images
		WHERE name = 'news2' and category = 'news2' ";

		$sql3 = "INSERT INTO output_images(imageType ,imageData, name, category)
		VALUES('{$imageProperties3['mime']}', '{$imgData3}', 'news3', 'news3')";
		$sqlnext3 = "SELECT * FROM output_images
		WHERE name = 'news3' and category = 'news3' ";
